...
INSERT INTO "new_Student" ("age", "courseId", "createdAt", "email", "firstName", "id", "image", "lastName", "middleName", "updatedAt") SELECT "age", "courseId", "createdAt", "email", "firstName", "id", "image", "lastName", "middleName", "updatedAt" FROM "Student";
DROP TABLE "Student";
