...
INSERT INTO "new_Student" ("age", "courseId", "createdAt", "email", "firstName", "id", "image", "lastName", "middleName", "sex", "updatedAt") SELECT "age", "courseId", "createdAt", "email", "firstName", "id", "image", "lastName", "middleName", "sex", "updatedAt" FROM "Student";
DROP TABLE "Student";
