...
INSERT INTO "new_Student" ("courseId", "createdAt", "firstName", "id", "image", "lastName", "middleName", "updatedAt") SELECT "courseId", "createdAt", "firstName", "id", "image", "lastName", "middleName", "updatedAt" FROM "Student";
DROP TABLE "Student";
